                    ...
                    <div class="card p-4">
                        ...
                        <div class="auth-brand text-center mb-2">
                            <a href="../../" class="logo-dark">
                                <img src="/assets/images/logo-uma.png" alt="dark logo" height="28">
                            </a>
                        ...
                        <div class="p-4 text-center">
                            ...
                            <h3 class="fw-bold text-uppercase">Acceso denegado</h3>
                            <p class="text-muted fs-5">
                                No tienes permiso para acceder a esta página o realizar la acción solicitada.
                            </p>
                            
                            <div class="mt-4 d-flex justify-content-center gap-1">
                                <button class="btn btn-primary" onclick="window.location.href='../../'">Ir al inicio</button>
                                <button class="btn btn-outline-secondary" onclick="window.location.href='../../'">Volver</button>
                            </div>
                        </div>
